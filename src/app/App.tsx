      ...
      <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-5 md:px-8 text-center pt-20 md:pt-0">
          ...
          <h1 className="font-black uppercase leading-[0.85] mb-6 md:mb-8" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2.8rem, 13vw, 10.5rem)" }}>
            ...
            <span className="block text-foreground text-left text-[96px]">{content.heroLine3}</span>
            <span className="block text-justify text-[136px]" style={{ WebkitTextStroke: "clamp(1px, 0.2vw, 2px) rgba(237,233,226,0.55)", color: "transparent" }}>{content.heroLine4}</span>
          </h1>
